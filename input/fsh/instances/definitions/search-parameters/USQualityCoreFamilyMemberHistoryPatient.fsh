Instance: us-quality-core-family-member-history-patient
InstanceOf: SearchParameter
Usage: #definition
* url = "http://hl7.org/fhir/us/quality-core/SearchParameter/us-quality-core-family-member-history-patient"
* version = "1.0.0"
