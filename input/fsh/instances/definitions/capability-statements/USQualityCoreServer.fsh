...
* description = "This capability statement describes the expected capabilities of US Quality Core Servers\nthat are responsible for responding to USCDI+ Quality V2 queries submitted by US Quality Core Clients.\nIt describes a minimum set of FHIR RESTful operations and search parameters necessary to enable access\nto the set of USCDI+ Quality V2 data that is in scope of this implementation guide. For more information\nabout which USCDI+ Quality data elements are in scope, please review the [USCDI+ Quality](uscdiquality.html) section\nof this implementation guide.\n\nUS Quality Core Servers **SHALL** support the capabilities described in the [US\nCore Server CapabilityStatement\nSTU9](https://hl7.org/fhir/us/core/STU9/CapabilityStatement-us-core-server.html).\nSome RESTful operations and search parameters described in the US Quality Core Server CapabilityStatement are redundant\nto the US Core Server CapabilityStatement, but are listed here to highlight which\ncapabilities are specifically relevant to USCDI+ Quality V2.\n\nThis version of US Quality Core targets USCDI+ Quality V2 data elements and builds directly on US Core 9.0.0.\nOnly the US Quality Core and US Core profiles that contain in-scope USCDI+ Quality V2 data are required to be supported\nby US Quality Core Servers. The FHIR RESTful operations and search parameters in this capability statement\nreflect this scope.\n"
* kind = #requirements
* fhirVersion = #4.0.1
* format = #json
