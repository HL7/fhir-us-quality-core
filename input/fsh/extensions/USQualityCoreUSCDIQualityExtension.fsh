...
Description: "This extension is used only in US Quality Core profile StructureDefinitions. It flags elements, types, and target profiles that represent USCDI+ Quality V2 data elements. Systems are expected to support flagged content as applicable to their role in US Quality Core data exchange. See the [Must Support](must-support.html) and [USCDI+ Quality](uscdiquality.html) pages for more information."
...
* . 0..1
  ...
  * ^definition = "This extension flags elements, types, and target profiles that represent USCDI+ Quality V2 data elements. Systems are expected to support flagged content as applicable to their role in US Quality Core data exchange. See the [Must Support](must-support.html) and [USCDI+ Quality](uscdiquality.html) pages for more information."
  * ^isModifier = false
* value[x] 1..1
