Profile: USQualityCoreNonPatientObservation
Parent: Observation
...
* subject 1..1
* subject only Reference(http://hl7.org/fhir/us/core/StructureDefinition/us-core-device|9.0.0 or USQualityCoreLocation)
  * ^short = "The device/location the observation is about"
  * ^definition = "The device/location this observation is about and into whose record the observation is placed. If the actual focus of the observation is different from the subject (or a sample of, part, or region of the subject), the `focus` element or the `code` itself specifies the actual focus of the observation."
...
* derivedFrom 0..* SU
* derivedFrom only Reference(USQualityCoreSimpleObservation or QuestionnaireResponse or USQualityCoreImagingStudy or http://hl7.org/fhir/us/core/StructureDefinition/us-core-documentreference|9.0.0 or Media or MolecularSequence)
