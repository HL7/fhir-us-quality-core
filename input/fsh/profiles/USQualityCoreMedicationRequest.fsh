...
* status ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
  ...
  * ^short = "(USCDI+ Quality) active | on-hold | cancelled | completed | entered-in-error | stopped | draft | unknown"
* intent ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
  * ^extension.valueBoolean = true
  * ^short = "(USCDI+ Quality) proposal | plan | order | original-order | reflex-order | filler-order | instance-order | option"
* doNotPerform 0..1
...
* medication[x] from $vsac-medication-clinical-drug (extensible)
  ...
  * ^short = "(USCDI+ Quality) Medication to be taken"
  * ^condition = "mrq-1"
...
* authoredOn 0..1
  * ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
  * ^extension.valueBoolean = true
  * ^short = "(USCDI+ Quality) When request was initially authored"
...
* reasonCode ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
  * ^extension.valueBoolean = true
  * ^short = "(USCDI+ Quality) Reason or indication for ordering or not ordering the medication"
* reasonReference 0..*
  * ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
  * ^extension.valueBoolean = true
  * ^short = "(USCDI+ Quality) US Quality Core Condition or Observation that supports the prescription"
...
* dosageInstruction ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
  * ^extension.valueBoolean = true
  * ^short = "(USCDI+ Quality) How medication should be taken"
  ...
  * timing ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
    ...
    * repeat ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
      * ^extension.valueBoolean = true
      * ^short = "(USCDI+ Quality) When the event is to occur"
      * bounds[x] ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
        * ^extension.valueBoolean = true
        * ^short = "(USCDI+ Quality) Length/Range of lengths, or (Start and/or end) limits"
      * frequency ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
        * ^extension.valueBoolean = true
        * ^short = "(USCDI+ Quality) Event occurs frequency times per period"
      * frequencyMax ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
        * ^extension.valueBoolean = true
      ...
      * period ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
        * ^extension.valueBoolean = true
        * ^short = "(USCDI+ Quality) Event occurs frequency times per period"
      * periodMax ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
        * ^extension.valueBoolean = true
        * ^short = "(USCDI+ Quality) Upper limit of period (3-4 hours)"
      * periodUnit ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
        * ^extension.valueBoolean = true
        * ^short = "(USCDI+ Quality) s | min | h | d | wk | mo | a - unit of time (UCUM)"
  * asNeeded[x] ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
    * ^extension.valueBoolean = true
  ...
  * doseAndRate ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
    ...
    * dose[x] ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
      * ^extension.valueBoolean = true
      * ^short = "(USCDI+ Quality) Amount of medication per dose"
* dispenseRequest ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
  * ^extension.valueBoolean = true
  * ^short = "(USCDI+ Quality) Medication supply authorization"
  * initialFill 0..0
  * dispenseInterval ^short = "Minimum period of time between dispenses"
  * validityPeriod ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
    * ^extension.valueBoolean = true
    * ^short = "(USCDI+ Quality) Time period supply is authorized for"
  * numberOfRepeatsAllowed ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
    * ^extension.valueBoolean = true
    * ^short = "(USCDI+ Quality) Number of refills authorized"
  * quantity ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
    * ^extension.valueBoolean = true
    * ^short = "(USCDI+ Quality) Amount of medication to supply per dispense"
  * expectedSupplyDuration ^extension.url = "http://hl7.org/fhir/us/quality-core/StructureDefinition/us-quality-core-uscdi-quality-extension"
    * ^extension.valueBoolean = true
