...
|US Quality Core (1.0.0) Profile|US Core Profile|FHIR Resource|
|----|:----:|----:|
|**2.1.1 AdverseEvent**|
...
|&emsp; &emsp; [US Quality Core Communication Done](StructureDefinition-us-quality-core-communicationdone.html)| &mdash; | &mdash; |
|&emsp; &emsp; [US Quality Core Communication Not Done](StructureDefinition-us-quality-core-communicationnotdone.html)| &mdash; | &mdash; |
...
|**2.1.12 Device**|
|  &mdash; |[US Core Device]({{site.data.fhir.ver.uscore}}/StructureDefinition-us-core-device.html) |&emsp; [ Device]({{site.data.fhir.path}}device.html)|
...
|&emsp; &emsp; [US Quality Core Device Requested](StructureDefinition-us-quality-core-devicerequested.html)| &mdash; | &mdash; |
|&emsp; &emsp; [US Quality Core Device Prohibited](StructureDefinition-us-quality-core-deviceprohibited.html)| &mdash; | &mdash; |
...
|&emsp; &emsp; [US Quality Core Immunization Done](StructureDefinition-us-quality-core-immunizationdone.html)| &mdash; | &mdash; |
|&emsp; &emsp; [US Quality Core Immunization Not Done](StructureDefinition-us-quality-core-immunizationnotdone.html)| &mdash; | &mdash; |
...
|&emsp; &emsp; [US Quality Core MedicationAdministration Done](StructureDefinition-us-quality-core-medicationadministrationdone.html)| &mdash; | &mdash; |
|&emsp; &emsp; [US Quality Core MedicationAdministration Not Done](StructureDefinition-us-quality-core-medicationadministrationnotdone.html)| &mdash; | &mdash; |
...
|&emsp; &emsp; [US Quality Core MedicationDispense Done](StructureDefinition-us-quality-core-medicationdispensedone.html)| &mdash;  | &mdash; |
|&emsp; &emsp; [US Quality Core MedicationDispense Declined](StructureDefinition-us-quality-core-medicationdispensedeclined.html)| &mdash; | &mdash; |
...
|&emsp; &emsp; [US Quality Core Medication Requested](StructureDefinition-us-quality-core-medicationrequested.html)| &mdash; | &mdash; |
|&emsp; &emsp; [US Quality Core Medication Prohibited](StructureDefinition-us-quality-core-medicationprohibited.html)| &mdash; | &mdash; |
...
|&emsp; &emsp; [US Quality Core Procedure Done](StructureDefinition-us-quality-core-proceduredone.html)| &mdash; | &mdash; |
|&emsp; &emsp; [US Quality Core Procedure Not Done](StructureDefinition-us-quality-core-procedurenotdone.html)| &mdash; | &mdash; |
...
|&emsp; &emsp; [US Quality Core Service Requested](StructureDefinition-us-quality-core-servicerequested.html)| &mdash; | &mdash; |
|&emsp; &emsp; [US Quality Core Service Prohibited](StructureDefinition-us-quality-core-serviceprohibited.html)| &mdash; | &mdash; |
|**2.1.40 Specimen**|
...
|&emsp; &emsp; [US Quality Core Task Done](StructureDefinition-us-quality-core-taskdone.html)| &mdash; | &mdash; |
|&emsp; &emsp; [US Quality Core Task Rejected](StructureDefinition-us-quality-core-taskrejected.html)| &mdash; | &mdash; |
{: .list}
