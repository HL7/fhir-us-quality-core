...
<ul>
<li>status: (USCDI+ Quality) registered | partial | preliminary | final +</li>
<li>category: (USCDI+ Quality) Service category</li>
<li>category:LaboratorySlice: (USCDI+ Quality) Service category</li>
<li>code: (USCDI+ Quality) US Core Laboratory Report Order Code</li>
<li>effective[x]: (USCDI+ Quality) Diagnostically relevant time (typically the time of specimen collection)</li>
<li>result: (USCDI+ Quality) Observations</li>
</ul>
