...
<li>category:us-core: (USCDI+ Quality) Service category</li>
<li>code: (USCDI+ Quality) US Quality Core Report Code</li>
<li>effective[x]: (USCDI+ Quality) Diagnostically relevant time (typically the time of the procedure)</li>
