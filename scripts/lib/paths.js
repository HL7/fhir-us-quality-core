...
const STATIC_ASSETS_DIR = path.join(IG_ROOT, 'input', 'images');
const GENERATED_STATIC_ASSETS_DIR = path.join(STATIC_ASSETS_DIR, 'generated');
...
const USCDI_QUALITY_CSV_PATH = path.join(GENERATED_STATIC_ASSETS_DIR, 'uscdi-quality-data-elements.csv');
